                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <hr />
                            <form:form method="post" action="/admin/phongban/update" modelAttribute="newPhongBan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <form:input type="text" class="form-control" path="maPhongBan" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Tên phòng ban:</label>
                                    <form:input type="text" class="form-control" path="tenPhongBan" />
                                </div>
                                <div class="mb-3">
