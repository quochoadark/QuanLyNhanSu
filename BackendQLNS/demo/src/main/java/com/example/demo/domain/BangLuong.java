...
public class BangLuong {
    ...
    public BangLuong(String maLuong, int ngay, int thang, int nam, float luongCoban, float chamCong, float phuCap,
            float ungLuong, float truLuong, float thucLanh, float luongTangCa, NhanVien maNhanVien) {
    ...
    public String toString() {
        return "BangLuong [maLuong=" + maLuong + ", ngay=" + ngay + ", thang=" + thang + ", nam=" + nam
